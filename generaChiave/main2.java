...
public class main2 {
	...
	public static void main (String[] args) {
		...
		try {
			...
			System.out.println("Chiave pubblica: "+pubsenzarn);
			System.out.println("Chiave priv: "+privsenzarn);
			...
			System.out.println(crittato);
			 ...
			 byte[] decryptedMessageBytes = cipher2.doFinal(ciphertext);
			 String decryptedMessage = new String(decryptedMessageBytes, "UTF-8");
			System.out.println("Il messaggio e': " + decryptedMessage);
